...
if submit_button:
    ...
    def get_popular_words(sentiment_name, urls):
        ...
        prompt = (
            ...
            f"What are 10 popular phrases found in these websites that may explain this sentiment? Only list phrases that have to do with the {query}. I want to know the reasons the article writers are expressing the sentiment. These don't need to be but will hopefully tell us what {query} can improve upon or what they are doing correctly. Make sure to select quotes from a range of these websites and not just a couple. List the words with bullet points but don't inlude the url."
        )
